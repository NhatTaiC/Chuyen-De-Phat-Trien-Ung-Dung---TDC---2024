...
namespace DTO
{
    public class DTO_Log
    {
        ...
        // Constructors
        public DTO_Log(int id, string log_name, string model, int model_id, string data_olds, string data_news, int is_deleted, int created_by, DateTime created_at, int updated_by, DateTime updated_at)
        {
            this.id = id;
        ...
        public DTO_Log(int id, string log_name, string model, int model_id, string data_olds, string data_news)
        {
            this.id = id;
            this.log_name = log_name;
            this.model = model;
        ...
        public DTO_Log(string log_name, string model, int model_id, string data_olds, string data_news)
        {
            this.log_name = log_name;
            this.model = model;
            this.model_id = model_id;
